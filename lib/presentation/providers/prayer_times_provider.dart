...
@riverpod
Future<PrayerTimesResponse> prayerTimes(ref) async {
  ...
  if (userLocation != null) {
    log('--- Fetching prayer times for lat: ${userLocation.latitude}, lon: ${userLocation.longitude} ---');
...
@riverpod
Future<UserLocation?> userLocation(ref) async {
  final locationStorageService = ref.watch(locationStorageServiceProvider);
